...
def train(
    ...
    eval_dataset = ContrastiveLearningDataset(
        cif_path='/mnt/minio/battery/xrd/datasets/raw_data/mp_cif_npy',
        xrd_path='/mnt/minio/battery/xrd/datasets/raw_data/mp_xrd',
...
if __name__ == '__main__':
    ...
    parser.add_argument('--use_qformer', type=bool, default=False)
    parser.add_argument('--cif_input_dim', type=int, default=64)
    parser.add_argument('--cif_num_queries', type=int, default=4)
