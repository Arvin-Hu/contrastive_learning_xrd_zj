import numpy as np
from models.crystalsystem_model import XRDClassificationModel,XRDFormulaClassificationModel,XRDClassificationRegressionModel
from models.reg_model import XRDRegressionModel, XRDConvRegressionModel, XRDFormulaModel
from trainers.crystalsystem_trainer import (
    FormationEnergyTrainer,
    RegressionTrainer,
    CrystalSystemClassificationTrainer,
    CrystalSystemClassificationRegressionTrainer
)
...
def train(
    ...
    elif model_class == 'XRDClassificationRegressionModel':
    ...
    elif trainer_class == 'CrystalSystemClassificationRegressionTrainer': 
        trainer = CrystalSystemClassificationRegressionTrainer(
            model=model,
            train_loader=train_loader,
            val_loader=eval_loader,
            learning_rate=learning_rate,
